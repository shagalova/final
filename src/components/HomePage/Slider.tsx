...
useEffect(() => {
  ...
  return (
    <div className='wrapper  flex justify-center items-center w-full '>
      ...
      <button className='leftAr cursor-pointer ' onClick={handleLeftArrowClick} ref={leftRef}>
      ...
      <button className='rightAr cursor-pointer ' onClick={handleRightArrowClick} ref={rightRef}>
